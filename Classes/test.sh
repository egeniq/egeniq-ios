...
#!/bin/bash
"uncrustify" -f "$file2indent" -c "/Users/peter/Desktop/uncrustify.cfg" -l OC -o indentoutput.tmp
...
#!/bin/bash
"uncrustify" -f "$1" -c "/Users/peter/Desktop/uncrustify.cfg" -l OC -o indentoutput.tmp
mv indentoutput.tmp "$1"

else
echo "ERROR: As parameter given directory or file does not exist!"
echo "Syntax is: test.sh dirname filesuffix"
echo "Syntax is: test.sh filename"
echo "Example: test.sh temp cpp"
exit 1
fi
fi
